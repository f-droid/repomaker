...
class ScreenshotForm(ModelForm):
    class Meta:
        ...
        labels = {
            'language_tag': 'Language Code',  # TODO would be nice to have a language dropdown here
            'file': 'Select Screenshot for upload',
        }
        help_texts = {
            'language_tag': 'Leave this at \'en-US\' if in doubt.',
        }
